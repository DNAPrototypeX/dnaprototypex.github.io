...
<frameset cols="115,*" framespacing="0" border="0" frameborder="no">
	<frameset rows="100%,*" cols="115">
    	<frame name="titre" src="filmograph0.html" scrolling="no" marginwidth="0" marginheight="0" noresize="noresize" frameborder="no">
    <frame src="UntitledFrame-2"></frameset>
	<noframes></noframes>
<frame name="main" src="filmographie.html" marginwidth="0" marginheight="0" noresize="noresize" frameborder="no" />
<noframes> 
<BODY>
<h1>Filmographie de l'oeuvre de Moliere</h1>
<h2>Documents cinmatographiques ou tlvisuels, sur la vie de Molire, ou  des mises en scne franaises et trangres de ses oeuvres.</h2>

<br />
<b>Warning</b>:  mysql_connect() [<a href='function.mysql-connect'>function.mysql-connect</a>]: Access denied for user 'toutmoli'@'localhost' (using password: YES) in <b>/home/toutmoli/www/2008/filmographie/index.php</b> on line <b>31</b><br />
